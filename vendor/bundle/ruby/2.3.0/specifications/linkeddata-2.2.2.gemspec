# -*- encoding: utf-8 -*-
# stub: linkeddata 2.2.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rdf-aggregate-repo>.freeze, ["~> 2.1"])
      s.add_runtime_dependency(%q<rdf-isomorphic>.freeze, ["~> 2.0"])
      s.add_runtime_dependency(%q<rdf-json>.freeze, ["~> 2.0"])
      s.add_runtime_dependency(%q<rdf-microdata>.freeze, ["~> 2.1"])
      s.add_runtime_dependency(%q<rdf-n3>.freeze, ["~> 2.1"])
      s.add_runtime_dependency(%q<rdf-normalize>.freeze, ["~> 0.3"])
      s.add_runtime_dependency(%q<rdf-rdfa>.freeze, ["~> 2.1"])
      s.add_runtime_dependency(%q<rdf-rdfxml>.freeze, ["~> 2.0"])
      s.add_runtime_dependency(%q<rdf-reasoner>.freeze, ["~> 0.4"])
      s.add_runtime_dependency(%q<rdf-tabular>.freeze, ["~> 2.2"])
      s.add_runtime_dependency(%q<rdf-trig>.freeze, ["~> 2.0"])
      s.add_runtime_dependency(%q<rdf-trix>.freeze, ["~> 2.0"])
      s.add_runtime_dependency(%q<rdf-turtle>.freeze, ["~> 2.2"])
      s.add_runtime_dependency(%q<rdf-vocab>.freeze, ["~> 2.1"])
      s.add_runtime_dependency(%q<rdf-xsd>.freeze, ["~> 2.1"])
      s.add_runtime_dependency(%q<json-ld>.freeze, ["~> 2.1"])
      s.add_runtime_dependency(%q<ld-patch>.freeze, ["~> 0.3"])
      s.add_runtime_dependency(%q<sparql>.freeze, ["~> 2.1"])
      ...
      s.add_dependency(%q<rdf-aggregate-repo>.freeze, ["~> 2.1"])
      s.add_dependency(%q<rdf-isomorphic>.freeze, ["~> 2.0"])
      s.add_dependency(%q<rdf-json>.freeze, ["~> 2.0"])
      s.add_dependency(%q<rdf-microdata>.freeze, ["~> 2.1"])
      s.add_dependency(%q<rdf-n3>.freeze, ["~> 2.1"])
      s.add_dependency(%q<rdf-normalize>.freeze, ["~> 0.3"])
      s.add_dependency(%q<rdf-rdfa>.freeze, ["~> 2.1"])
      ...
      s.add_dependency(%q<rdf-trix>.freeze, ["~> 2.0"])
      s.add_dependency(%q<rdf-turtle>.freeze, ["~> 2.2"])
      s.add_dependency(%q<rdf-vocab>.freeze, ["~> 2.1"])
      s.add_dependency(%q<rdf-xsd>.freeze, ["~> 2.1"])
      s.add_dependency(%q<json-ld>.freeze, ["~> 2.1"])
      s.add_dependency(%q<ld-patch>.freeze, ["~> 0.3"])
      s.add_dependency(%q<sparql>.freeze, ["~> 2.1"])

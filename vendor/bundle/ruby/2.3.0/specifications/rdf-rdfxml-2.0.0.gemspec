# -*- encoding: utf-8 -*-
# stub: rdf-rdfxml 2.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.rubyforge_project = "rdf-rdfxml".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rdf-rdfa>.freeze, ["~> 2.0"])
      ...
      s.add_dependency(%q<rdf-rdfa>.freeze, ["~> 2.0"])

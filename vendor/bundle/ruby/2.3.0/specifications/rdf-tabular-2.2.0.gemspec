# -*- encoding: utf-8 -*-
# stub: rdf-tabular 2.2.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<bcp47>.freeze, [">= 0.3.3", "~> 0.3"])
      s.add_runtime_dependency(%q<rdf>.freeze, ["~> 2.1"])
      s.add_runtime_dependency(%q<rdf-vocab>.freeze, ["~> 2.0"])
      s.add_runtime_dependency(%q<rdf-xsd>.freeze, ["~> 2.0"])
      s.add_runtime_dependency(%q<json-ld>.freeze, ["~> 2.0"])
      ...
      s.add_dependency(%q<bcp47>.freeze, [">= 0.3.3", "~> 0.3"])
      s.add_dependency(%q<rdf>.freeze, ["~> 2.1"])

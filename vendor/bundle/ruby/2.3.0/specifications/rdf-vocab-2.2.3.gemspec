...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<json-ld>.freeze, ["~> 2.1"])
      s.add_development_dependency(%q<json-schema>.freeze, ["~> 2.7"])
      s.add_development_dependency(%q<jsonpath>.freeze, ["~> 0.8"])
      s.add_development_dependency(%q<ld-patch>.freeze, ["~> 0.3"])
      s.add_development_dependency(%q<nokogiri>.freeze, ["~> 1.8"])
      s.add_development_dependency(%q<nokogumbo>.freeze, ["~> 1.4"])
      s.add_development_dependency(%q<rake>.freeze, ["~> 12.0"])
      s.add_development_dependency(%q<rdf-rdfa>.freeze, ["~> 2.2"])
      s.add_development_dependency(%q<rdf-reasoner>.freeze, ["~> 0.4"])
